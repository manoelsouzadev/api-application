...
exports.getCounts = async (req, res) => {
  ...
  let data = [
    ...
    { label: "Campanhas", data: campanhaCount},
    { label: "Cultos", data: cultoCount},
    { label: "Ensaios", data: ensaioCount},
    { label: "Eventos", data: eventoCount},
    { label: "Lembretes", data: lembreteCount},
